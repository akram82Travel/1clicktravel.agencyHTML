...
//    }
    ...
    public function findByDestination($Destination): array
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.Destination = :val')
            ->setParameter('val', $Destination)

            //->andWhere('c.Check_In = :val')
            //->setParameter('val', $Check_In)

            //->andWhere('c.Check_Out = :val')
            //->setParameter('val', $Check_Out)
            ->setMaxResults(10)
            ->getQuery()
            ->getResult()
        ;
